...
def get_nifty500_data():
    try:
        ...
        return {"all": fallback, "large": fallback, "mid": [], "small": [], "nifty200": fallback}, {t: "Unknown" for t in fallback}
...
ticker_lists, cap_mapping = get_nifty500_data()
...
ranking_timeframe = st.selectbox(
    "Rank Stocks By:",
    ("6-Month Velocity", "3-Month Velocity", "1-Month Velocity")
)
